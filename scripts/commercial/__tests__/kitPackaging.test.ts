...
describe('commercial artifact paths', () => {
  ...
  it('wires generated artifact metadata onto the figma manifest', () => {
    ...
    expect(['pending', 'generated', 'ready', 'failed']).toContain(artifacts?.stage);
    expect(['pending', 'generated', 'failed']).toContain(artifacts?.generationStatus);
    expect(artifacts?.commercialReady).toBe(artifacts?.generationStatus === 'generated');
